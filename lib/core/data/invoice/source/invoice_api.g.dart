...
class _InvoiceApi implements InvoiceApi {
  _InvoiceApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<Invoice>> getLatestInvoice(String afterIso) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'after': afterIso};
